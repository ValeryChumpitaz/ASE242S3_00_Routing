...
export class DashboardComponent {
  ...
  productos: Producto[] = [
    c{ id: 1, nombre: 'Cupcake de Chocolate', descripcion: 'Delicioso cupcake con frosting de chocolate', precio: 3.5, imagen: 'https://tse4.mm.bing.net/th/id/OIP.VvC9jQQoYHduetOdQeZs_QHaFj?pid=Api&P=0&h=180' }, 
